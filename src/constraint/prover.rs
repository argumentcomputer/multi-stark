...
use crate::config::{
    Domain, EvaluationsOnDomain, PackedChallenge, PackedVal, StarkGenericConfig, Val,
};
use crate::lookup::{LookupValues, fingerprint};
use crate::prover::{Commitments, Proof};

use super::eval::VarValues;
use super::system::{ProverKey, System, SystemWitness};
...
fn quotient_values<SC>(
    circuit: &super::system::Circuit<Val<SC>>,
